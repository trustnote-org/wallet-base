...
var objectLength = require('../crypto/object_length.js');
...
var sqlitePool = require('../db/sqlite_pool.js');
var path = '../offline/initial.trustnote-light.sqlite';
var db = sqlitePool(path,1, false, function(err){
    console.log('err---------', err );
});
...
function composeJoint(params){
    ...
    console.log('composeJoint---params-:\n', JSON.stringify(params, null,3));
    ...
    */
    ...
    async.series([
        ...
        function(cb){ // authors
            ...
            async.eachSeries(arrFromAddresses, function(from_address, cb2){ 
                ...
                signer.readSigningPaths(conn, from_address, function(assocLengthsBySigningPaths){
                    ...
                    console.log('--------objUnit----', JSON.stringify(objUnit, null, 3));
                    cb2();
                    // conn.query(
        ...
        function(cb){ // input coins
            ...
            objUnit.headers_commission = objectLength.getHeadersSize(objUnit); //子单元的佣金
            ...
            pickDivisibleCoinsForAmount(
                ...
                function(arrInputsWithProofs, _total_input){
                    console.log('-----pickDivisibleCoinsForAmount-------onDone----arrInputsWithProofs:',arrInputsWithProofs);
